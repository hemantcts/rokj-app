        ...
        <div>
            <nav className="navbar navbar-expand-lg my-navbar sticky1" id="navid">
                <div className="container">
                    <Link className="navbar-brand" to="/rokj-app">
                        <img src={logo} alt="" />
                    </Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto">
                            <li className="nav-item">
                                <Link className="nav-link" aria-current="page" to="/rokj-app">Über uns</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to="/rokj-app">Idee und Zweck</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to="/rokj-app">Erfahrungsberichte</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to="/rokj-app">Antrag stellen</Link>
                            </li>
                            <li className="nav-item">
